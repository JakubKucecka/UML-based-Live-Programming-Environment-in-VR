...
public class MyLaserPointer : OVRCursor
{
    ...
    public Transform emulatedParent;
    public GameObject cursorVisual;
    public float maxLength = 10.0f;

    private bool isBeingEmulated = false;
    ...
    private void Awake()
    {
        ...
        isBeingEmulated = emulateInEditor && Application.isEditor;
        if (isBeingEmulated)
        {
            transform.SetParent(emulatedParent, false);
        }
    }
